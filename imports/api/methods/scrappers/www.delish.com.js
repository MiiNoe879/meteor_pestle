...
Meteor.methods({
  scrapFromdelish(url,bodyHtml){
    let receipeJSON = {};

    x(bodyHtml, ['.article-title'])(Meteor.bindEnvironment(function(errName, resName) {
    ...
    x(bodyHtml, ['.recipe-ingredients-item'])(Meteor.bindEnvironment(function(errIngredient, resIngredient) {
    ...
    x(bodyHtml, ['.recipe-directions-item'])(Meteor.bindEnvironment(function(errInstruction, resInstruction) {
    ...
    x(bodyHtml, ['.recipe-info-serves'])(Meteor.bindEnvironment(function(errServing, resServing) {
      if(resServing[0]){
